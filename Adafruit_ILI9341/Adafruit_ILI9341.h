 ...
 *          datasheet
 * @link    datasheet   https://cdn-shop.adafruit.com/datasheets/ILI9341.pdf
 ...
 * @return  uint8_t*    pointer to dataset returned from read
 */
...
/*!
 * @brief   prints an array of pixels
 ...
 */
void ILI9341_PrintArr(cursor_t* cur, uint16_t* arr, uint8_t height, uint8_t width, uint8_t scale);
