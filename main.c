...
void HAL_TIM_PeriodElapsedCallback(TIM_HandleTypeDef *htim)
{
	...
	{
	case HOMESCREEN:
		Homescreen_TouchHandler(&cur, point);
		break;

	case SETTINGS:
		Settings_TouchHandler(&cur, point);
		break;

	}
}

void Homescreen_TouchHandler(cursor_t* cur, TSPoint point)
{
...
void Settings_TouchHandler(cursor_t* cur, TSPoint point)
{
