...
int main(void)
{
  ...
  while (1)
  {
    ...
    case SETTINGS:
      // If user trying to increase Font Size
      if(STMPE610_TouchedArea(point, 171, 202)) {
        __disable_irq();
        STMPE610_ClearPoint(&point);
      ...
      // If user trying to decrease Font Size
      else if(STMPE610_TouchedArea(point, 171, 18)) {
        __disable_irq();
        STMPE610_ClearPoint(&point);
      ...
      // If user trying to increase arrow Size
      if(STMPE610_TouchedArea(point, 286, 202))
      {
    	  __disable_irq();
    	  STMPE610_ClearPoint(&point);
      ...
      // If user trying to decrease arrow Size
      else if(STMPE610_TouchedArea(point, 286, 18))
      {
    	  __disable_irq();
    	  STMPE610_ClearPoint(&point);
      ...
      // If user trying to increase brightness
      if(STMPE610_TouchedArea(point, 56, 202))
      {
    	  __disable_irq();
    	  STMPE610_ClearPoint(&point);
      ...
      // If user trying to decrease brightness
      else if(STMPE610_TouchedArea(point, 56, 18))
      {
    	  __disable_irq();
    	  STMPE610_ClearPoint(&point);
      ...
      // If user pressed return
      else if(STMPE610_TouchedArea(point, 20, 220)) {
        __disable_irq();
